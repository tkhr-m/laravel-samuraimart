...
<div class="container d-flex justify-content-center mt-3">
  <div class="w-75">
    ...
    <form method="post" action="{{route('carts.destroy')}}" class="d-flex justify-content-end mt-3">
      ...
      <div class="modal fade" id="buy-confirm-modal" data-backdrop="static" data-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="sataticBackdropLabel" aria-hidden="true">
